...
// The wolf grim reaper — self-contained SVG art (no upload needed), shown inside
// a circular, ember-lit frame that gently floats. If you drop your own square
// image at public/reaper.png it overrides this automatically.
...
export default function Reaper({ size = 120, round = true }) {
  // Prefer the user's uploaded wolf; then a dropped public/reaper.png; then SVG.
  const userImg = useStore((s) => s.images?.reaper || '')
  const src = userImg || '/reaper.png'
